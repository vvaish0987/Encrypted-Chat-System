...
void combine(char *str1, const char *str2)
{
    ...
    while (1)
    {
        ...
        if (option == '1')
        {
            ...
            while (1)
            {
                ...
                xor_encrypt_decrypt(file_line, hist_key, strlen(file_line), strlen(hist_key));
                strcat(file_line, "\n");
        ...
        else if (option == '2')
        {
            ...
            while (1)
            {
                ...
                // Open log file for this client with the client's name
                FILE *file = fopen(client_name, "a");
                if (!file)
                {
                    printf("Could not open file to save chat history.\n");
                    closesocket(server_sock);
